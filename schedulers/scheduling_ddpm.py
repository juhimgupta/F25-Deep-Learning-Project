...
class DDPMScheduler(nn.Module):
    ...
    def set_timesteps(
        ...
        #timesteps = num_inference_steps 
            # build evenly-spaced timesteps from T-1 down to 0 (int64)
        ...
        timesteps = torch.arange(0, self.num_train_timesteps, step_size, dtype=torch.long)
    ...
    def previous_timestep(self, timestep):
        ...
        # get index of current timesteps in self.timesteps
    ...
    def _get_variance(self, t):
        ...
        prev_t = self.previous_timestep(t_int)
        ...
        if self.variance_type == "fixed_small":
            ...
            if t == 1: #maybe comment?
                variance = variance #maybe comment?
        else:
    ...
    def add_noise(
        ...
        sqrt_one_minus_alpha_prod = torch.sqrt(1 - alphas_cumprod[timesteps].to(original_samples.device))
        ...
        noisy_samples = original_samples * sqrt_alpha_prod + noise * sqrt_one_minus_alpha_prod # (noise is epsilon)
